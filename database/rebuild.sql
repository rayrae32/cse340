...
(
    wishlist_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY (INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1),
    ...
    CONSTRAINT fk_inventory FOREIGN KEY (inv_id)
        ...
        ON UPDATE CASCADE
        ON DELETE CASCADE,
    CONSTRAINT unique_wishlist UNIQUE (account_id, inv_id)
)
TABLESPACE pg_default;
